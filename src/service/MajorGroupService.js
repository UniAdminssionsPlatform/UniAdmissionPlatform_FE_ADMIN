...
export const MajorGroupDetail = (data) =>
  CallAPI(`${GET_MAJOR_GROUP}/${data}`, "get", data);
export const UpdateMajorGroup = (data) =>
  CallAPI(`${UPDATE_MAJOR_GROUP}/${data.id}`, "put", data);
export const DeleteMajorGroup = (data) =>
  CallAPI(`${DELETE_MAJOR_GROUP}/${data}`, "delete");
