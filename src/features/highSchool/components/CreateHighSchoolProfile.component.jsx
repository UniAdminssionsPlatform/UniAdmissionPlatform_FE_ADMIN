...
import SingleUploadWithPreviewContainer
    from "../../../components/commons/UploadImage/SingleUploadWithPreview.container";
                    ...
                    <Col span={5}>
                        ...
                        >
                            <Input
                                ...
                                suffix={
                                    <Tooltip
                                        title="Số điện thoại bao gồm 10-11 số và không có dấu cách">
                                        <InfoCircleOutlined
                                            style={{color: "rgba(0,0,0,.45)"}}
                                        />
                                    </Tooltip>
                            ...
                            rules={[
                                {
                                    ...
                                    message:
                                        "email phải có cấu trúc đầy đủ ( abc@gmail.com )",
                                },
                            ]}
                        >
                            <Input
                                ...
                                suffix={
                                    <Tooltip
                                        title="Email phải đúng cú pháp. Ví dụ : abc@gmail.com">
                                        <InfoCircleOutlined
                                            style={{color: "rgba(0,0,0,.45)"}}
                                        />
                                    </Tooltip>
